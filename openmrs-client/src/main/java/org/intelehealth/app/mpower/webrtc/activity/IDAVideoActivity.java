package org.intelehealth.app.mpower.webrtc.activity;
...
import org.intelehealth.app.mpower.databinding.ActivityVideoCallBinding;
...
//        args.setUrl(BuildConfig.LIVE_KIT_URL);
        args.setUrl(ApplicationConstants.LIVE_KIT_URL);
        args.setCallType(CallType.VIDEO);
        args.setSocketUrl(ApplicationConstants.SOCKET_URL + "?userId=" + args.getNurseId() + "&name=" + args.getNurseName());
