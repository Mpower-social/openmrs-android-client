...
import org.intelehealth.app.mpower.activities.community.contact.AboutActivity;
import org.intelehealth.app.mpower.activities.community.contact.ContactUsActivity;
import org.intelehealth.app.mpower.activities.dialog.CustomFragmentDialog;
import org.intelehealth.app.mpower.activities.introduction.SplashActivity;
import org.intelehealth.app.mpower.activities.login.LoginActivity;
import org.intelehealth.app.mpower.activities.settings.SettingsActivity;
...
//                    CallHandlerUtils.INSTANCE.operateIncomingCall(this, arg);
    ...
    public void showMultiDeletePatientDialog(ArrayList<Patient> selectedItems) {
        CustomDialogBundle bundle = new CustomDialogBundle();
        bundle.setTitleViewMessage(getString(org.intelehealth.app.mpower.R.string.delete_multiple_patients));
        bundle.setTextViewMessage(getString(org.intelehealth.app.mpower.R.string.delete_multiple_patients_dialog_message));
